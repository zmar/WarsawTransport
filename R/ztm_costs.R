...
tickets_costs_daily_ZTM <- function(travel_time, discount, zone, varsovian) {
    ...
    # Calculating the number of tickets for a given travel time during one year - number of tickets needed in one day multiplied by number of periods of time a given ticket
    # type is valid
