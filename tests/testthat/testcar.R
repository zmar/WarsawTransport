...
test_that("car_costs correct results", {
    # output as numeric
    expect_equal(car_costs(start_point = "Lublin", finish_point = "Warszawa", fuel_consumption = 1, fuel_price = 1, insurence_fee = 100, parking_time = 1, travelers_number = 1), 
        4.974673 - 3.97e-07)
})
...
test_that("car_costs errors - value - handling handling input vector of length 2", {
    ...
    expect_error(car_costs(start_point = "Lublin", finish_point = "Warszawa", fuel_consumption = 1, fuel_price = 1, insurence_fee = 100, parking_time = 1, travelers_number = c(1, 
        1)))
})
